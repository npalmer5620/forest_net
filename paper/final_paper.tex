...
Fig.~\ref{fig:energy_comparison} compares network lifetime between tree-only and hybrid tree+mesh routing. The hybrid approach consistently outperforms tree-only across all 3 energy levels: with minor improvement at $E_0 = 0.1$\,mAh (600\,s vs. 500\,s), at 0.25\,mAh (1400\,s vs. 1200\,s), and a more substantial improvement at 0.5\,mAh (2700\,s vs. 2400\,s). The absolute network lifetime increases with energy level, confirming that mesh shortcuts reduce hop count and energy per packet over the entire lifetime of the network.
